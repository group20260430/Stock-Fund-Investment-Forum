...
INSERT INTO users (phone, email, password_hash, nickname, bio) VALUES
  ('13800000001', 'system@example.com', 'replace_with_real_hash', '系统用户', '系统初始化用户'),
  ('13800000002', 'fund@example.com', 'replace_with_real_hash', '基金观察者', '关注基金配置与长期投资')
ON DUPLICATE KEY UPDATE
  bio = VALUES(bio);
